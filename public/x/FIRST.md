...
Coup Ahoo is a dice hull. You play it on the site. You launch $AHOO after The Chest is live.

MECHANICS
You roll 3d6. That stack is your ship. Pips are hit points. The number of dice is how many balls you throw. Empty deck sinks.
...
INFRASTRUCTURE
Chain: Robinhood Chain (4663). Quote: ETH. Pad: LetsCash. Tax: 3% on the ETH leg. Platform 0.3%. 2.7% to The Chest.
...
Ship & dice loop inspired by Coup Ahoo © Antti Haavikko (js13k). Chest, token and chain original.
